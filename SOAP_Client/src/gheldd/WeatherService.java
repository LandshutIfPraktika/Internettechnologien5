 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://gheldd/", wsdlLocation = "http://localhost:8080/ws/w?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICE_QNAME = new QName("http://gheldd/", "WeatherService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ws/w?wsdl");
    ...
    public Weather getWeatherPort() {
        return super.getPort(new QName("http://gheldd/", "WeatherPort"), Weather.class);
    }
    ...
    public Weather getWeatherPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://gheldd/", "WeatherPort"), Weather.class, features);
    }
